...
data_dir = os.path.join(current_dir, "./test_circuit_55/4096_3dencap55.csv")
...
def execute(C):
    ...
    for i in range(d):
        ...
        if i == d - 1:
            ...
            W_iplus1_with_line, value_at_b, value_at_c = prover_inst.send_Wi_on_line(
                i, r
            )
            if DEBUG_INFO:
                print(
...
test_circuit = circuit.createCircuit(data_dir, [12, 13, 18, 19], mpz(prime))
